...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		switch (PlayState.SONG.song.toLowerCase())
		{
			...
			case 'thorns':
				...
				FlxG.sound.music.fadeIn(1, 0, 0.8);
			case 'the-end':
				FlxG.sound.playMusic(Paths.music('bopz'), 0);
				FlxG.sound.music.fadeIn(1, 0, 0.8);
			case 'finale':
				FlxG.sound.playMusic(Paths.music('bopz'), 0);
				FlxG.sound.music.fadeIn(1, 0, 0.8);
    ...
    else if (PlayState.SONG.song.toLowerCase()=='the-end' || PlayState.SONG.song.toLowerCase()=='finale' || PlayState.SONG.song.toLowerCase()=='dababy')
	{	
		portraitLeft = new FlxSprite(-1500, 10);
		portraitLeft.frames = Paths.getSparrowAtlas('reapPortrait', 'shared');
		portraitLeft.animation.addByPrefix('enter', 'reap Portrait Enter', 24, false);
	...
	else if (PlayState.SONG.song.toLowerCase()=='the-end' || PlayState.SONG.song.toLowerCase()=='finale' || PlayState.SONG.song.toLowerCase()=='dababy')
	{
		...
		portraitRight.frames = Paths.getSparrowAtlas('reapbfPortrait', 'shared');
