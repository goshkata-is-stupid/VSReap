...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'schoolEvil':
				...
				var evilTrail = new FlxTrail(dad, null, 4, 1, 0.3, 0.069);
		...
		healthBar.createFilledBar(0xFF646566, 0xFF0278ED);
		// healthBar
		add(healthBar);
	...
	private function generateStaticArrows(player:Int):Void
	{
		for (i in 0...4)
		{
			...
			switch (SONG.noteStyle)
			{
                ...
                case 'boner':
					babyArrow.frames = Paths.getSparrowAtlas('BONENotes');
					babyArrow.animation.addByPrefix('green', 'arrowUP');
					babyArrow.animation.addByPrefix('blue', 'arrowDOWN');
					babyArrow.animation.addByPrefix('purple', 'arrowLEFT');
					babyArrow.animation.addByPrefix('red', 'arrowRIGHT');
	...
	override public function update(elapsed:Float)
	{
		...
		if (generatedMusic)
			...
			.mustPress && daNote.tooLate && !FlxG.save.data.downscroll || daNote.mustPress && daNote.tooLate && FlxG.save.data.downscroll) && daNote.mustPress)
					{
	...
	*/
	...
	override function stepHit()
	{
		...
		if (curStep == 447 && curSong == 'The-End')
		{
			remove(dad);
			dad = new Character(100, 100, 'dababy');
			add(dad);
		}
